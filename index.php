...
=======
    ...
    .feature-video { width:100%; max-width:1200px; background: linear-gradient(180deg,var(--azul) 0%, var(--azul-mid) 100%); border-radius:10px; padding:18px; box-sizing:border-box; }
    .feature-video .feature-label { color: #ffffff; font-family: var(--font-sc); font-weight:600; letter-spacing:0.08em; text-transform:uppercase; font-size:0.95rem; padding:6px 12px; }
    .feature-video-card { margin-top:14px; background: #ffffff; border-radius:12px; overflow:hidden; box-shadow: 0 14px 40px rgba(10,36,99,0.08); }
    .feature-video-card video { width:100%; height:auto; display:block; }
    @media (max-width:900px){ .feature-video{ padding:14px } }
    </style>
>>>>>>> dc018a1 (update 05-06-2026)
</head>
<body>
...
=======
        ...
        <div class="feature-video-wrap reveal-up" data-delay="200">
            <div class="feature-video">
                <div class="feature-label">100 días de gestión</div>
                <div class="feature-video-card">
                    <video controls playsinline preload="metadata" poster="img/img/video-poster.jpg">
                        <source src="videos/video 100 dias" type="video/mp4">
